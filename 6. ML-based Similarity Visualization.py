...
folder_path = os.path.join('refined_data','SWH_OUTPUT_SIMILARITY')  # Please replace with your actual folder path
...
directory = os.path.join('refined_data','GITHUB_OUTPUT_REFINED_SIMILARITY')   # Please replace with your actual folder path
